          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-3">
              <div className="relative w-10 h-10 bg-gradient-to-r from-purple-500 to-cyan-500 rounded-xl flex items-center justify-center shadow-lg">
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-purple-500 to-cyan-500 rounded-xl opacity-75 animate-pulse"></div>
              </div>
...
>
  Sign In
              ...
              <Link 
  to="/judge" 
  className="relative bg-gradient-to-r from-purple-600 to-cyan-600 text-white px-6 py-2 rounded-lg overflow-hidden group"
>
...
>
  Sign In
                ...
                <a href="#problems" className="bg-gradient-to-r from-purple-600 to-cyan-600 text-white px-6 py-2 rounded-lg text-center">
                  Start Coding
                </a>
              </div>
            </div>
